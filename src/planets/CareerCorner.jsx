...
function CareerCorner() {
	const initiative = {
        ...
        Career Corner is a space for women in tech to not only pause, reflect, and take intentional steps forward in their careers, but participate in skill building sessions to practise skills that underpin any career.
        ...
        Whether you’re returning from a break, settling into a new role, or looking to level up, this is your opportunity to reconnect with your goals, design the path that fits you best and practise the skills that’ll get you there, along with other women doing the same.
		`,
		initiativeLink:
		...
		initiativeFAQs: [
			{
				...
				details: `This initiative is for already working engineers, mostly focused on those on the IC track, but it's generic enough for managers too.
				          For Reflection Sessions or Career Check-ins, you don't need to bring anything in particular, but if you have your brag book, learning plan or 1-1 notes, these might be useful to have on hand.
