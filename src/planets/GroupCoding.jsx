...
function GroupCoding() {
  return (
    ...
    <div className={styles.groupcodingTile}>
        ...
        <div>
          <p>
          Our Group Coding sessions are held every Wednesday evening. They focus on hands-on skill development through pair programming and Test Driven Development - a safe space to practice and discuss code with other women. <br />
